...
nthp::vectGen nthp::generatePixelPosition(nthp::worldPosition pos, nthp::RenderRuleSet* ruleset) {
        return nthp::vectGen(nthp::fixedToInt(nthp::f_fixedProduct(pos.x, ruleset->scaleFactor.x)), nthp::fixedToInt(nthp::f_fixedProduct(pos.y, ruleset->scaleFactor.y)));
}

nthp::vector<nthp::fixed_t> nthp::generateWorldPosition(nthp::vectGen pos, nthp::RenderRuleSet* ruleset) {
